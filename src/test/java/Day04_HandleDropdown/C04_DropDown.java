...
public class C04_DropDown {
    ...
    public void test1() {
        ...
        System.out.println("visible : " + select.getFirstSelectedOption().getText()); // visible : Option 1

        // Tüm dropdown değerleri(value) yazdırın
        List<WebElement> valuTum = select.getOptions();
        System.out.print("tum degerler : ");

        for (WebElement w : valuTum) {
        ...
        // False yazdırın.
        System.out.println();
        System.out.println("DropDown boyutu : " + select.getOptions().size());
