...
public class C03_DropDown {
    ...
    public void test2() {
        ...
        Eğer Dropdown menudeki option'a string olarak ulaşmak istersek
        bu methodu kullanırız
         */
        ...
        select.selectByValue("search-alias=stripbooks-intl-ship"); // Eğer dropdown menusundeki optiona value ile ulaşmak istersek bu methodu kullanırız
         ...
         /*
        Dropdown menude seçtiğimiz optiona ulaşmak istersek
        select.getFirstSelectedOption() methodunu kullanırız
         */
